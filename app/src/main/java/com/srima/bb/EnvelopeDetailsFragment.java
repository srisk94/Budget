...
public class EnvelopeDetailsFragment extends Fragment
    ...
    @Override public View onCreateView(LayoutInflater inflater, ViewGroup cont,
        ...
        mId = state != null && state.containsKey("com.srima.bb.envelope")
            ? state.getInt("com.srima.bb.envelope")
            : getArguments().getInt("com.srima.bb.envelope", -1);
        mShowTransactionId = state == null
            ? getArguments().getInt("com.srima.bb.transaction", -1)
            : -1;
        mEnvelopeData = null;
        mLogData = null;
    ...
    @Override public void onSaveInstanceState(Bundle state) {
        ...
        state.putInt("com.srima.bb.envelope", mId);
    }
